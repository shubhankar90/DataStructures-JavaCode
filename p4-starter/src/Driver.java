...
//		String text = Util.loadFile(Constants.DRACULA);
		...
		System.out.println("The savings is " + (text.length() * Constants.BITESIZE - bits.length()) + " bits.");
		String packing = zipper.compress(bits);
		System.out.println("The compressed text is encoded in " + packing.length() + " characters.");
		System.out.println("The savings is " + (text.length() - packing.length()) + " characters.");
